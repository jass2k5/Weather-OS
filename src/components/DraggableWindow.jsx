...
export const DraggableWindow = ({ children, title, Appid, defaultpos = { x: 300, y: 100 } }) => {
    ...
    return (
        ...
        >
            ...
            >
                <div className="window-header shrink-0 w-full h-7 cursor-grab active:cursor-grabbing bg-zinc-800 p-12 flex items-center justify-center relative border-b border-cyan-500/10">
