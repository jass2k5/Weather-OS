...
export const WeatherMap = () => {
    ...
    return (
        ...
        <div ref={containerRef} className="mapContainer h-full w-full absolute inset-0 z-40 overflow-hidden">
                ...
                >
                    <SkeletonTheme baseColor="rgba(255, 255, 255, 0.05)" highlightColor="rgba(255, 255, 255, 0.15)">
                        ...
                        <div className="relative z-10 flex flex-col items-center gap-3">
                            ...
                            <span className="text-cyan-100/70 font-mono tracking-[0.2em] text-xs">INITIALIZING...</span>
                        </div>
                    </SkeletonTheme>
                </div>
            )}
